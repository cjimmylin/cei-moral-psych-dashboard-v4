...
(function () {
  ...
  function renderAIDisclosure() {
    ...
    var text = (DATA.executiveSummary && DATA.executiveSummary.aiDisclosure) ||
      'All disciplinary perspectives and interpretive analyses were generated by Claude (Anthropic) without human expert review. ' +
      'Quantitative data and statistical analyses are computationally derived from the source benchmarks.';
    el.textContent = text;
  }
